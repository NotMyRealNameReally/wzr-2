	...
	int       nCmdShow)
{
	...
	main_window = CreateWindow(class_name, "WZR 2021/22, temat 2, wersja c [Y-autopilot, F10-test autop.]", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
